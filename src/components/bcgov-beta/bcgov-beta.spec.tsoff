...
describe("bcgov-beta", () => {
  ...
  it("Render Beta", async () => {
    ...
    <bcgov-beta aria-label="This is my beta message" role="alert" class="bcgov-beta" tabindex="0" >Beta</bcgov-beta>
    `);
  });
  it("Render Beta Custon Label", async () => {
    ...
    expect(page.root).toEqualHtml(`
    <bcgov-beta label="Custom Beta" aria-label="This is my beta message" role="alert" class="bcgov-beta" tabindex="0" >Custom Beta</bcgov-beta>
    `);
  });
});
