...
describe("bcgov-button", () => {
  ...
  it("Render Hamburger Button", async () => {
    ...
    expect(page.root).toEqualHtml(`
    <bcgov-button button-style="hamburger" class="bcgov-button">
      <button aria-expanded="false" class="hamburger" aria-label="Hamburger" >
        <div></div>
  ...
  it("Render Search Button", async () => {
    ...
    <bcgov-button button-style="search" class="bcgov-button" >
      <button aria-expanded="false" class="search" aria-label="Search" >  
        ...
        <span class="bcgov-button-text"><div></div><span class="bcgov-button-text">Search</span></span>
      </button>
    </bcgov-button>
    `);
  });
