...
const BcgovButton = class {
    ...
    render() {
        ...
        if (["hamburger", "search"].includes(this.buttonStyle)) {
            return (core.h(core.Host, { target: this.target }, core.h("button", { class: btnStyle, "aria-expanded": "false" }, core.h("div", null), core.h("slot", null))));
        }
        else {
            if ("button" === this.link) {
                return (core.h("button", { class: btnStyle }, core.h("slot", null)));
            }
            else {
